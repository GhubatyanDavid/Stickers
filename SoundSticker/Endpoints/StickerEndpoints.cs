...
public static class StickerEndpoints
{
    ...
    public static RouteGroupBuilder MapStickerEndpoints(this RouteGroupBuilder api)
    {
        api.MapPost("/stickers/from-video", CreateVideoStickerAsync)
            ...
            .WithDescription("Queues sticker processing from an uploaded video, GIF, or image. Set outputFormat=Gif for silent GIF output, or Webp for a Telegram-compatible static WebP sticker file. Use shape to export square, circle, portrait, or landscape stickers. Set isPublic=true to show it in All Stickers after processing.")
        ...
        api.MapPost("/stickers/from-image", CreateImageStickerAsync)
            ...
            .WithDescription("Queues sticker processing from an uploaded image by looping it into MP4 or GIF, or exporting a Telegram-compatible static WebP sticker file. Use shape to export square, circle, portrait, or landscape stickers. Use Mute or UseMedia audio mode.")
            .Accepts<CreateVideoStickerRequest>("application/json")
            .Produces<StickerResponse>(StatusCodes.Status202Accepted)
            .Produces<ProblemResponse>(StatusCodes.Status400BadRequest)
            .Produces<ProblemResponse>(StatusCodes.Status401Unauthorized)
        ...
        api.MapGet("/stickers/{id:guid}/download", DownloadSticker)
            ...
            .WithDescription("Downloads the generated MP4, GIF, or WebP when the sticker is owned by the current X-User-Id or ready and public.")
